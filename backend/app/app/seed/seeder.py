...
async def db_seeder(db, owner_id):
    with open("app/seed/accounts.json") as f:
        ...
        for account in accounts:
            ...
            await crud.account.create_with_owner(db=db, obj_in=account_in, owner_id=owner_id)
    ...
    with open("app/seed/places.json") as f:
        ...
        for place in places:
            ...
            await crud.place.create_with_owner(db=db, obj_in=place_in, owner_id=owner_id)

    with open("app/seed/expenses.json") as f:
        expenses = json.load(f)
        for expense in expenses:
            print("🚀 ~ file: seeder.py:18 ~ expense:", expense, type(expense['account_id']))
            ...
            await crud.expense.create_with_owner(db=db, obj_in=expense_in, owner_id=owner_id)
    ...
    with open("app/seed/incomes.json") as f:
        ...
        for income in incomes:
            ...
            await crud.income.create_with_owner(db=db, obj_in=income_in, owner_id=owner_id)
    ...
    with open("app/seed/transfers.json") as f:
        ...
        for transfer in transfers:
            ...
            await crud.transfer.create_with_owner(db=db, obj_in=transfer_in, owner_id=owner_id)
