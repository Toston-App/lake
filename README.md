# Clever - Financial Tracking Application

Clever is an efficient financial tracking application designed to help you effectively manage your expenses ensuring the privacy and security of your financial data. It offers various features to record, categorize, and generate reports on your expenses and incomes.
...
JSON based web API based on OpenAPI: http://localhost:9000

Automatic interactive documentation with Swagger UI (from the OpenAPI backend): http://localhost:9000/docs

Alternative automatic documentation with ReDoc (from the OpenAPI backend): http://localhost:9000/redoc
...
The following docs were generated by FastAPI and need to be updated to reflect the actual application features.
